...
However, the math makes no mention about what probability actually is in the real world. The axioms help us in a wide range of situations, so surely they must describe some aspect of reality.

# So what *is* probability?
We use "probabilities" in multiple different contexts:
