Abc files are a way of storing music sheets in plain text format. They have a `.abc` extension. Programs exist that can typeset these files into a proper sheet music image, or play it via midi.

An [[Abc file|abc file]] contains [[Abc information fields|information fields]] and an [[Abc tune body|abc tune body]]. While all the specifics are good to know in general, here is an example of a piano song:
